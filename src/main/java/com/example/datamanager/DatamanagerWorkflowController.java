...
public class DatamanagerWorkflowController {
	...
	public StudyInfo updateStudent(@PathVariable String workflowId, @PathVariable String studyUid) {
		log.info("Will launch WF {} on study {}", workflowId, studyUid);
		// TODO start the WF
		StudyInfo study = DatamanagerStudyController.studies.findByUid(studyUid);
		return study;
	}
}